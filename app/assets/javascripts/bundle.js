...
/***/ function(module, exports, __webpack_require__) {
	...
	window.TodoStepStore = __webpack_require__(165);
	...
	var TodoList = React.createClass({
	  ...
	  render: function () {
	    ...
	    this.state.list.forEach(function (todo) {
	      htmlList.push(React.createElement(TodoListItem, { key: todo.id, todo: todo }));
	    });
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        null,
	        this.state.showDetails ? React.createElement(TodoDetailView, { todo: this.props.todo }) : null
	      ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ReactDOM = __webpack_require__(158);
	var TodoStepList = __webpack_require__(166);
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        null,
	        'Steps: ',
	        React.createElement(TodoStepList, { todo: this.props.todo })
	      ),
	      React.createElement(
	        'button',
	        { value: this.props.todo.id, onClick: this.handleDestroy },
	        'Delete'
	      )
	    );
	  }
	...
	var TodoForm = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement('br', null),
	      React.createElement('br', null),
	      React.createElement('input', { type: 'submit', value: 'New Todo List Item' })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ReactDOM = __webpack_require__(158);
	var TodoStepStore = __webpack_require__(160);
	
	var TodoStepList = React.createClass({
	  displayName: 'TodoStepList',
	  ...
	  render: function () {
	    ...
	    this.state.list.forEach((function (todoStep) {
	      if (todoStep.id === this.props.todo.id) {
	        htmlList.push(React.createElement(
	          'li',
	          { key: todoStep.id },
	          todoStep.body
	        ));
